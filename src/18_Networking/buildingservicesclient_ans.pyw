...
class BuildingServicesClient(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.bookingsOnDateButton = QtWidgets.QPushButton("Bookings &on Date?")
        self.bookingsForRoomButton = QtWidgets.QPushButton("Bookings &for Room?")
        ...
        self.connect(self.dateEdit, QtCore.SIGNAL("dateChanged(QDate)"), self.updateUi)
        ...
        self.connect(
            self.bookingsOnDateButton, QtCore.SIGNAL("clicked()"), self.bookingsOnDate
        )
        self.connect(
            self.bookingsForRoomButton, QtCore.SIGNAL("clicked()"), self.bookingsForRoom
        )
    ...
    def bookingsForRoom(self):
        self.issueRequest("BOOKINGSFORROOM", self.roomEdit.text(), self.dateEdit.date())
    ...
    def readResponse(self):
        ...
        while True:
            ...
            if action == "ERROR":
                ...
                msg = "Room {} is booked on: {}".format(room, dates)
